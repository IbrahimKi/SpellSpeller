...
{
    /// <summary>
    /// Card-spezifische Extensions für Hand Management und Visual Effects
    /// Unity 6 LTS optimiert, modular, performant
    /// </summary>
    public static class CardExtensions
    {
        ...
        public static bool TrySelect(this Card card)
        {
            ...
            // Check if playable using GameExtensions
            if (!GameSystem.Extensions.GameExtensions.IsPlayable(card)) return false;
